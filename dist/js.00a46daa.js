...
},{"dom7/dist/dom7.modular":"../node_modules/dom7/dist/dom7.modular.js","ssr-window":"../node_modules/ssr-window/dist/ssr-window.esm.js"}],"../node_modules/swiper/dist/css/swiper.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/variables.js":[function(require,module,exports) {
"use strict";
...
(0, _jquery.default)(document).ready(function () {
  (0, _jquery.default)('.category-item').click(function () {
    var category = (0, _jquery.default)(this).attr('id');

    if (category == 'all') {
      (0, _jquery.default)('.outer-sell-item').removeClass('hide-sell');
    } else {
      (0, _jquery.default)('.outer-sell-item').addClass('hide-sell');
      (0, _jquery.default)('.' + category).removeClass('hide-sell');
    }

    var btnContainer = (0, _jquery.default)(".category-container");
    var btns = (0, _jquery.default)(".category-item");
...
window.addEventListener('scroll', function () {
  ...
  (0, _jquery.default)('.counter').each(function () {
...
var swiper = new _swiper.default('.swiper-first-container', {
  autoplay: {
    delay: 5000
  },
  spaceBetween: 30,
...
var swiper = new _swiper.default('.swiper-second-container', {
  effect: 'flip',
  autoplay: {
    delay: 2000
  },
